...
const EN = {
    ...
    'settings.resolution.fullscreenHint': 'Exclusive fullscreen. Esc or switch mode to change window size.',
    'settings.resolution.borderlessHint': 'Borderless window covering the whole monitor. Esc or switch mode to change window size.',
