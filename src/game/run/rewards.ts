...
const CARD_BLURBS: Record<string, string> = {
    ...
    'corner-strike': 'Diagonal bend: enters the left/right neighbor; that card\'s arrow finishes the corner.',
    'corner-defense': 'Diagonal bend: enters the left/right neighbor; that card\'s arrow finishes the corner.',
    skewer: 'Leap 2: activates the card you jump over for effects, then lands ahead (mid arrow ignored).',
    ...
    thorns: 'Adds 1 thorn this energy round — enemy attacks reflect that damage back.',
