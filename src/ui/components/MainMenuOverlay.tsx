...
type MenuScreen = 'home' | 'settings' | 'how-to-play' | 'credits';
...
}: MainMenuOverlayProps) =>
{
    ...
    const startRun = (): void =>
    {
        emitRunSfx('ui-select', { volume: 0.9, rate: 1.02 });
        onStart();
    };
                ...
                {screen === 'home' && (
                    <>
                        ...
                        <div className="main-menu__actions">
                            <button type="button" className="main-menu__start" onClick={startRun}>
                                Start run
                            </button>
                            <button
                                type="button"
